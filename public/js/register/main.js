...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('add_producto').addEventListener('click', () => {
    ...
    const produccion_mensual = document.getElementById('produccion_mensual').value;
    ...
    productManager.addRow([nombre_producto, produccion_mensual, ventas_mensuales, ventas_anuales]);
  });
  ...
  document.getElementById('add_medio_digital').addEventListener('click', () => {
    ...
    const nombre_medio = document.getElementById('nombre_medio_adicional').value;
    const registro_medio = document.getElementById('medio_adicional_registro').value;
  ...
  document.getElementById('add_documento_adicional').addEventListener('click', () => {
    ...
    const denominacion_documento = document.getElementById('denominacion_documento_adicional').value;
    const documento = document.getElementById('nombre_documento_adicional').files[0].name;
