...
import { ManagerElements } from "../main/managerElements.js";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("add_producto").addEventListener("click", () => {
    ...
    productManager.addRow(productManagerElements.get_and_clear([
      "nombre_producto",
      "produccion_mensual",
      "ventas_mensuales",
      "ventas_anuales",
  ...
  document.getElementById("add_medio_digital").addEventListener("click", () => {
    ...
    digitalManager.addRow(digitalManagerElements.get_and_clear([
  ...
  document
    ...
    .addEventListener("click", () => {
      ...
      documentManager.addRow(documentManagerElements.get_and_clear([
