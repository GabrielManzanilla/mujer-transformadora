...
@section('content')
	<div class="w-full h-full px-4 pt-4">
		...
		<div class="w-full bg-gray-200 rounded-full h-5 dark:bg-gray-400">
			<div class="bg-[#6D1528] h-5 rounded-full text-center text-[#c2995c] font-bold pb-5" style="width: 45%">45%</div>
		</div>
		<form action="" id="registerForm" class="flex flex-row w-full h-full gap-2 px-5 ">
			<div class="flex flex-col flex-1 mt-8">
				<div class="w-full">
					<ul id="indicatorsSection" class="w-full text-lg">
						<li class=" text-[#c2995c] font-bold bg-[#6D1528] pl-5 p-2 rounded-l-lg"><span>U</span>
							<div class="ml-2 hidden md:inline">Datos Personales</div>
						</li>
					</ul>
				</div>
			</div>
			<div class="flex-col flex-6 md:flex-2 h-full w-full relative py-2 ">
				<div class="block h-full w-full overflow-auto pb-26" id="stepsForm">
					...
					<fieldset class="step hidden border border-gray-300 p-4 rounded-lg mb-4 " data-step="2">
						...
						<div class="flex justify-between px-3">
							<button type="button"
								class="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-[#6D1528] previous">Regresar</button>
							<button type="button"
								class="px-4 py-2 bg-[#6D1528] text-white rounded-md hover:bg-[#9e2b44] focus:outline-none focus:ring-2 focus:bg-[#9e2b44] next">Continuar</button>
						</div>
					</fieldset>

					<fieldset class="step border border-gray-300 p-4 rounded-lg mb-4" data-step="3">
						...
						<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							<div class="mb-4">
								<label for="tiempo_ejerciendo" class="block text-sm font-medium text-gray-700 mb-1">Tiempo
									ejerciendo</label>
								<input type="number"
									class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#6D1528]"
									id="tiempo_ejerciendo">
								<div class="mt-1 text-sm text-gray-500">**Tiempo en años</div>
							</div>
						</div>
						<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
							<div class="mb-4">
								<label for="establecimiento_usuario"
									class="block text-sm font-medium text-gray-700 mb-1">Establecimiento</label>
								<select
									class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#6D1528]"
									id="establecimiento_usuario">
					...
					<fieldset class="step hidden border border-gray-300 p-4 rounded-lg mb-4" data-step="6">
						<legend class="text-lg font-medium px-2">Subida de Archivos</legend>
						<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
							<div class="mb-4">
